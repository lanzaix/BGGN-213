...
2. The function is to asccess the pdb file, reduce it to specific and desired chain to analyze a given kinase
3. The output is to plot residue number  vs B-factor with noted secondary structure elements
